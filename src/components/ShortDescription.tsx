...
const ShortDescription = () => {
  ...
  return (
    <section>
      <div className="mx-auto px-4 py-28 gap-12 text-white md:px-8 xl:flex">
        <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
          ...
          <h1 className="text-4xl text-white font-extrabold mx-auto md:text-5xl">
            Explore in-demand <span>NFT&apos;s </span>
            and enjoy collecting top notch <span>NFT&apos;s </span>
          </h1>
          ...
          <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-start">
            <a
              ...
              className="btn rounded-3xl text-white bg-inherit border-[#5142FC] hover:bg-green-400 hover:text-white"
            >
              Browse <span>NFT&apos;s </span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                fill="currentColor"
            ...
            <a
              href="javascript:void(0)"
              className="btn rounded-3xl bg-white text-black hover:bg-green-400 hover:text-white"
            >
              Get access to pro
              <svg
                xmlns="http://www.w3.org/2000/svg"
